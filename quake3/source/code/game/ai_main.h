...
//PKMOD - Ergodic 04/14/01 - new code for bots to target enemy beartraps
//PKMOD - Ergodic 08/30/01 - reduce from 64 to 32 (practical)
#define MAX_BEARTRAPS				32

//PKMOD - Ergodic 08/30/01 - code for bots to target enemy autosentrys
#define MAX_AUTOSENTRYS				32

//PKMOD - Ergodic 08/30/01 - code for bots to avoid gravity wells
#define MAX_GRAVITYWELLS				8
...
typedef struct bot_state_s
{
	...
	//PKMOD - Ergodic 04/14/01 - new code for bots to target enemy beartraps
	int beartraps[MAX_BEARTRAPS];
	int numbeartraps;

//PKMOD - Ergodic 08/30/01 - code for bots to target enemy autosentrys
	int autosentrys[MAX_AUTOSENTRYS];
	int numautosentrys;

//PKMOD - Ergodic 08/30/01 - code for bots to target enemy autosentrys
	int gravitywells[MAX_GRAVITYWELLS];
	int numgravitywells;
