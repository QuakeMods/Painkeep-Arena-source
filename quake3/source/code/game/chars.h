...
// Last update:		2000-09-07 PKMOD Ergodic - PainkeepArena Integration
//					2000-10-16 PKMOD Ergodic, fixed characteristic 48, af and walker bug 
...
#define CHARACTERISTIC_AIM_ACCURACY_AIRFIST			49	//float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_AIRFIST			50	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_NAILGUN			51	//float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_NAILGUN			52	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_BEARTRAP		53	//float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_BEARTRAP			54	//float [0, 1]
