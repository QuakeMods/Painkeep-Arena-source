...
#define LittleShort
//PKMOD - Ergodic 11/11/01 - add "return" to remove comiler warning
...
//PKMOD - Ergodic 02/16/01 - add fontsize definitions
//			These definitions were added to extend existing font definitions that
//			are found in q_shared.h starting with "UI_LEFT"
#define UI_PKA_SMALLERFONT	0x00008000			//50%
#define UI_PKA_MICROFONT	0x00010000			//12/01/01 was 25% now 33%
#define PROP_PKA_SMALLER_SIZE_SCALE		0.5
#define PROP_PKA_MICRO_SIZE_SCALE		0.33	//12/01/01 was 25% now 33%
...
//PKMOD - Ergodic 02/11/02 - create radian conversion definition = (M_PI * 2 / 360)
#define M_RADIANCONVERSION	0.01745329251994329576924f	
...
//PKMOD - Ergodic 02/11/02 - Optimized anglevectors when all you need is "forward"
...
#define	BUTTON_NEXT_HOLDABLE	4096	//PKMOD - Ergodic 05/12/01 - add holdable cmd
