...
//PKMOD - Ergodic 04/22/02 - add PKA User Interface functions
#define UI_UPDATEPREVIEW	150
#define UI_MAPNAMETITLE		151
//PKMOD - Ergodic 04/24/02 - add PKA User Interface functions
#define UI_BOTHEAD0			152
#define UI_BOTHEAD1			153
#define UI_BOTHEAD2			154
#define UI_BOTHEAD3			155
#define UI_BOTHEAD4			156
#define UI_BOTHEAD5			157
#define UI_BOTHEAD6			158
#define UI_BOTHEAD7			159
//PKMOD - Ergodic 04/26/02 - add PKA User Interface functions
#define UI_MAPFRAGLIMIT		160
#define UI_MAPTIMELIMIT		161
#define UI_BOTTEXT0			162
#define UI_BOTTEXT1			163
#define UI_BOTTEXT2			164
#define UI_BOTTEXT3			165
#define UI_BOTTEXT4			166
#define UI_BOTTEXT5			167
#define UI_BOTTEXT6			168
#define UI_BOTTEXT7			169
//PKMOD - Ergodic 05/04/02 - add PKA User Interface functions
#define UI_MAPNAMETITLENET	170
//PKMOD - Ergodic 11/08/02 - Draw botname that is selected for removal
#define UI_BOTNAME2REMOVE	171
//PKMOD - Ergodic 11/27/02 - display of the map levelshot after game completes
#define UI_MAPPOSTVIEW		172
//PKMOD - Ergodic 11/30/02 - Add functionality to assign and display headmodels 
#define FEEDER_Q3HEADMODELS	173
//PKMOD - Ergodic 12/06/02 - Add functionality to select and play music in the UI menu
#define FEEDER_MUSIC		174
//PKMOD - Ergodic 09/11/03 - Add functionality for Server Hosted maps to be referenced
//			in the HUB
#define FEEDER_HUBALTS		175
//PKMOD - Ergodic 12/22/03 - Add functionality to set private bot skill in the UI
#define UI_PRIVATEBOTSKILL	176
//PKMOD - Ergodic 12/23/03 - Add functionality to set HUB Alternate maps in the UI
#define UI_HUBALT1			177
#define UI_HUBALT2			178
#define UI_HUBALT3			179
#define UI_HUBALT4			180
//PKMOD - Ergodic 12/24/03 - display of the Hub Alt map levelshot
#define UI_HUBALTPREVIEW1	181
#define UI_HUBALTPREVIEW2	182
#define UI_HUBALTPREVIEW3	183
#define UI_HUBALTPREVIEW4	184
//PKMOD - Ergodic 02/08/04 - add horizontal meters for ammo 
#define CG_PLAYER_AMMO_METER_HR2L	185		//Meter: Horizontal Right to Left fill
#define CG_PLAYER_AMMO_METER_HL2R	186		//Meter: Horizontal Left to Right fill
//PKMOD - Ergodic 02/08/04 - add horizontal meters for armor 
#define CG_PLAYER_ARMOR_METER_HR2L	187		//Meter: Horizontal Right to Left fill
#define CG_PLAYER_ARMOR_METER_HL2R	188		//Meter: Horizontal Left to Right fill
//PKMOD - Ergodic 02/08/04 - add relative score value to the HUD's gauges 
#define CG_PLAYER_RELATIVE_SCORE	189
//PKMOD - Ergodic 02/28/04 - add ownerdrawn filed for painkiller medal award
#define	CG_PAINKILLER		190
